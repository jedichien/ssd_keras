...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[faster_rcnn_pb2.DESCRIPTOR,ssd_pb2.DESCRIPTOR,])
...
_DETECTIONMODEL.fields_by_name['faster_rcnn'].message_type = faster_rcnn_pb2._FASTERRCNN
_DETECTIONMODEL.fields_by_name['ssd'].message_type = ssd_pb2._SSD
