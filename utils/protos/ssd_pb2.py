...
import box_coder_pb2
import box_predictor_pb2
import hyperparams_pb2
import image_resizer_pb2
import matcher_pb2
import losses_pb2
import post_processing_pb2
import region_similarity_calculator_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[anchor_generator_pb2.DESCRIPTOR,box_coder_pb2.DESCRIPTOR,box_predictor_pb2.DESCRIPTOR,hyperparams_pb2.DESCRIPTOR,image_resizer_pb2.DESCRIPTOR,matcher_pb2.DESCRIPTOR,losses_pb2.DESCRIPTOR,post_processing_pb2.DESCRIPTOR,region_similarity_calculator_pb2.DESCRIPTOR,])
...
_SSD.fields_by_name['image_resizer'].message_type = image_resizer_pb2._IMAGERESIZER
_SSD.fields_by_name['feature_extractor'].message_type = _SSDFEATUREEXTRACTOR
_SSD.fields_by_name['box_coder'].message_type = box_coder_pb2._BOXCODER
_SSD.fields_by_name['matcher'].message_type = matcher_pb2._MATCHER
_SSD.fields_by_name['similarity_calculator'].message_type = region_similarity_calculator_pb2._REGIONSIMILARITYCALCULATOR
_SSD.fields_by_name['box_predictor'].message_type = box_predictor_pb2._BOXPREDICTOR
_SSD.fields_by_name['anchor_generator'].message_type = anchor_generator_pb2._ANCHORGENERATOR
_SSD.fields_by_name['post_processing'].message_type = post_processing_pb2._POSTPROCESSING
_SSD.fields_by_name['loss'].message_type = losses_pb2._LOSS
_SSDFEATUREEXTRACTOR.fields_by_name['conv_hyperparams'].message_type = hyperparams_pb2._HYPERPARAMS
