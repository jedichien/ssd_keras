...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[optimizer_pb2.DESCRIPTOR,preprocessor_pb2.DESCRIPTOR,])
...
_TRAINCONFIG.fields_by_name['data_augmentation_options'].message_type = preprocessor_pb2._PREPROCESSINGSTEP
_TRAINCONFIG.fields_by_name['optimizer'].message_type = optimizer_pb2._OPTIMIZER
