...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[anchor_generator_pb2.DESCRIPTOR,box_predictor_pb2.DESCRIPTOR,hyperparams_pb2.DESCRIPTOR,image_resizer_pb2.DESCRIPTOR,losses_pb2.DESCRIPTOR,post_processing_pb2.DESCRIPTOR,])
...
_FASTERRCNN.fields_by_name['image_resizer'].message_type = image_resizer_pb2._IMAGERESIZER
_FASTERRCNN.fields_by_name['feature_extractor'].message_type = _FASTERRCNNFEATUREEXTRACTOR
_FASTERRCNN.fields_by_name['first_stage_anchor_generator'].message_type = anchor_generator_pb2._ANCHORGENERATOR
_FASTERRCNN.fields_by_name['first_stage_box_predictor_conv_hyperparams'].message_type = hyperparams_pb2._HYPERPARAMS
_FASTERRCNN.fields_by_name['second_stage_box_predictor'].message_type = box_predictor_pb2._BOXPREDICTOR
_FASTERRCNN.fields_by_name['second_stage_post_processing'].message_type = post_processing_pb2._POSTPROCESSING
_FASTERRCNN.fields_by_name['hard_example_miner'].message_type = losses_pb2._HARDEXAMPLEMINER
_FASTERRCNN.fields_by_name['second_stage_classification_loss'].message_type = losses_pb2._CLASSIFICATIONLOSS
